...
public interface JobCardBlService {
    InfoResponse add(String position,String wage,String experienceRequirement,String degreeRequirement,String address,String hr,String hrTitle,String enterpriseId) throws NotExistException;
    InfoResponse update(String id,String position,String wage,String experienceRequirement,String degreeRequirement,String address,String hr,String hrTitle) throws NotExistException;
